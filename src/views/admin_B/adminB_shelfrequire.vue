      ...
      setup() {
        ...
        const agree =async(row)=> {
          try{
            ...
            const response =await axios.put(`http://121.36.23.117:3000/api/bookshelf/school/application/Y`,schoolname)
            if(response.status){
              console.log(response.data)
            } 
          //   router.push({
      ...
      const disagree =async(row)=> {
          try{
            const _id = row._id;
                ...
                console.log(schoolname)
            const response =await axios.put(`http://121.36.23.117:3000/api/bookshelf/school/application/N`,schoolname)
            if(response.status){
              console.log(response.data)
